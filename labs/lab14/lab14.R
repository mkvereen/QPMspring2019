...
# 2. Run a bivariate linear regression model that includes just 
#    one independent variable, women's labor force participation




# 3. Check the residuals. Is there a problem of non-constant variance?




# 4. Repeat 2 and 3 including right.vote, women.ed, culture, 
